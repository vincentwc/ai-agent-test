...
@mcp.tool(description="search query word in Baidu")
def search_in_baidu_with_html(query: str):
    """
    在百度搜索指定关键词
...
def pretty_html(html: str):
    #  移除指定的标签，如：script、style、link、meta、symbol、path、canvas、avg 等
...
if __name__ == '__main__':
    ...
    # 当直接运行此文件时执行，作为测试入口
    # 调用搜索函数，搜索"北京的天气"
    res = search_in_baidu_with_html("北京的天气")
    print(res)
    # get_chrome_instance()
    # open_chrome()
